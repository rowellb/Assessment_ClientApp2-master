    ...
    class Program
    {
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Please try a different attitude");
                }
                else
                {
                    validResponse = true;
            ...
            do
            {
                ...
                if (!Enum.TryParse(Console.ReadLine(), out Monster.Group tribe))
                {
                    Console.WriteLine("Please try a different tribe");
                }
                else
                {                   
                    validResponse = true;
        ...
        static void DisplayUpdateMonster(List<Monster> monsters)
        {
            ...
            do
            {
                ...
                if (userResponse == "" || !int.TryParse(userResponse, out int age))
                {
                    Console.WriteLine("Please Try Again");                   
                }
                else
            ...
            do
            {
                ...
                userResponse = Console.ReadLine();
                if (userResponse == "" || !Enum.TryParse(userResponse, out Monster.EmotionalState attitude))
                {
                    Console.WriteLine("Please Try Again");
                }
                else
            ...
            do
            {
                ...
                if (userResponse == "" || !Enum.TryParse(userResponse, out Monster.Group tribe))
                {
                    Console.WriteLine("Please Try Again");
                }
                else
            ...
            {
                validResponse = false;
                Console.Write($"\tCurrently Active: {selectedMonster.Active} Active: ");
                userResponse = Console.ReadLine();
